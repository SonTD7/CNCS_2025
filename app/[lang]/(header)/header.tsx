                ...
                <div className="w-full flex space-x-11 justify-between 1lg:justify-start container items-center relative h-20">
                    <Link title="Logo" href="/" className="flex space-x-5 justify-center items-center">
                        <span className={cn(
                            ...
                            <span className="text-5xl font-bold">Mai </span><span className=" xl:text-lg xl:opacity-40">Việt</span> <span className="-ml-9 self-end 1text-5xl font-bold  xl:text-2xl">Sơn </span>
                        </span>
                    </Link>
