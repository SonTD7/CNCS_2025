...
export default function DarkMode() {
    ...
    return (
        <div className="w-full mx-auto relative">
            ...
            {
                isSafari && (
                    <span className="absolute top-10 scale-0 transition-all w-44 rounded bg-gray-800 p-2 text-xs text-white group-hover:scale-100 -left-12">✨ Tính năng không có trên safari bản cũ!</span>
                )
            }
        </div>
    );
