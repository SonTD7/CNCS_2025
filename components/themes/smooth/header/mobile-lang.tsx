...
export default function MobileLang() {
	...
	return (
		<div className="flex justify-between space-x-1">
			<a
				className="mx-2 p-1 border rounded-full hover:ring-1 ring-red-500 hover:bg-gradient-to-tr hover:from-slate-300 hover:to-red-200"
				href="/"
			...
			<a
				className="mx-2 p-1 border rounded-full hover:ring-1 ring-cyan-500 hover:bg-gradient-to-tr hover:from-slate-300 hover:to-cyan-200"
				href="/en"
