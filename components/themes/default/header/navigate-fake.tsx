...
export function NavigateFake() {
  return (
    <NavigationMenu>
      <NavigationMenuList>
        <NavigationMenuItem>
          <NavigationMenuTrigger>Page Example</NavigationMenuTrigger>
          <NavigationMenuContent>
            <ul className="grid gap-3 p-4 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                ...
                <NavigationMenuLink asChild>
                  ...
                  >
                    ...
                    <p className="text-sm leading-tight text-muted-foreground">
                      Beautifully designed components Category with Radix UI and
                      Tailwind CSS.
                    </p>
                  </Link>
                </NavigationMenuLink>
              ...
              <Link href="/faqs" title="FAQs">
                <ListItem title="FAQs">
                  FAQs Page with example data
                </ListItem>
              </Link>
              <Link href="/contact" title="Contact Page">
                <ListItem title="Contact Page">
