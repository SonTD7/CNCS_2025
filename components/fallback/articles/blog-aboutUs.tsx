            ...
            <main className="pt-8 pb-16 lg:pt-16 lg:pb-24 bg-white dark:bg-gray-900 antialiased">
                <div className="flex justify-between px-4 mx-auto max-w-screen-xl ">
                    <article className="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
                        ...
                        <p className="lead">
                            Những người làm việc trong lĩnh vực giúp đỡ chuyên nghiệp như bác sĩ, giáo viên, nhà tham vấn,... luôn dành trọn tâm huyết để hỗ trợ và chăm sóc người khác. Nhưng trong hành trình ấy, họ thường quên đi chính mình. Sức khỏe tinh thần và thể chất – điều quan trọng giúp họ tiếp tục công việc ý nghĩa – đôi khi lại bị gác lại.
                        </p>
                        <p>
                            Chăm Người Chăm Sóc (CNCS) ra đời với mong muốn thay đổi điều đó. Chúng tôi tin rằng, để có thể chăm sóc người khác thật tốt, trước tiên mỗi người cần được chăm sóc đúng cách. Tầm nhìn của chúng tôi là giúp những người trong ngành giúp đỡ tiếp cận các dịch vụ chăm sóc sức khỏe toàn diện, chất lượng và dễ dàng.
                        ...
                        <figure>
                            <img
                                src="https://datviettour.com.vn/uploads/images/tin-tuc/cam-nang-du-lich/du-lich-suc-khoe/du-lich-suc-khoe-1.jpg"
                                alt=""
                            />
                            <figcaption>Nguồn từ du lịch sức khỏe</figcaption>
                        </figure>
                        <strong> Sứ mệnh của CNCS:</strong>
                        {/* <h2>Getting started with Flowbite</h2> */}
                        <p>
                            Cung cấp các nguồn lực và dịch vụ chăm sóc sức khỏe tâm thần toàn diện, sáng tạo và linh hoạt.
                            Mang đến giải pháp dễ tiếp cận, kịp thời và hiệu quả, giúp họ duy trì sức khỏe tinh thần mạnh mẽ và thể chất dẻo dai.
                        </p>
                        <strong> Chúng tôi tin rằng:</strong>
                        <p>
                            Sức khỏe tinh thần là nền tảng để mỗi cá nhân vững vàng theo đuổi công việc của mình.
                            Việc chăm sóc người chăm sóc không chỉ giúp họ tái tạo năng lượng mà còn khẳng định giá trị và ghi nhận những đóng góp thầm lặng mà to lớn của họ.
                        </p>
                        <p>Chăm Người Chăm Sóc (CNCS) không chỉ là một dự án về sức khỏe. Đây là hành trình trao quyền, truyền cảm hứng và lan tỏa thông điệp: "Chăm mình trước khi chăm người" – bởi bạn xứng đáng được yêu thương và quan tâm.</p>
                        <p>
                            <em>Hãy đồng hành cùng chúng tôi và khám phá những điều ý nghĩa phía trước!</em>
                        </p>
                        {/* <p>
