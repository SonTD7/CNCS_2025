        ...
        <div className="scontainer my-8 1container" id="bloglist">
            ...
            <ul className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 p-2 xl:p-5">
                <li className="relative bg-white flex flex-col justify-between border rounded shadow-md hover:shadow-primary-400">
                    <Link className="relative" href="/blog/blog-details">
                        <div className="relative w-full aspect-video xl:min-h-[300px]">
                            <img
                                ...
                                loading="lazy"
                            />
                            <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-b  from-sprimary/[40%] to-sprimary-400 1from-gray-800 1to-gray-500 text-white">
                                <h2 className="text-xl font-semibold">[Khóa học]</h2>
                                <p className="font-medium text-sm">Hướng nghiệp cuộc sống cho giáo viên</p>
                            </div>
                        </div>
                    </Link>
                ...
                <li className="relative bg-white flex flex-col justify-between border rounded shadow-md hover:shadow-primary-400">
                    ...
                    <div className="flex flex-col justify-beetween gap-3 px-4 py-2">
                        <p className="text-gray-600 two-lines line-clamp-4">
                            WriteMe.ai is your #1 AI-powered content writing assistant that crafts
                            high-quality content at a fraction of the cost. This advanced solution
                            eliminates the need for manual writing and allows users to
                ...
                <li className="relative bg-white flex flex-col justify-between border rounded shadow-md hover:shadow-primary-400">
                    ...
                    <div className="flex flex-col justify-beetween gap-3 px-4 py-2">
                        <p className="text-gray-600 two-lines line-clamp-4">
                            ...
                            of features including post scheduling, collaboration tools, analytics,
                            and AI assistance to supercharge your social media strategy across
                            multiple platforms.
                        </p>
                        <ul className="flex flex-wrap items-center justify-start text-sm gap-2">
                            <li
                ...
                <li className="relative bg-white flex flex-col justify-start border rounded shadow-md hover:shadow-primary-400">
                    <Link className="relative" href="/blog/blog-details">
                        <div className="relative w-full aspect-video xl:min-h-[300px]">
                            <img
                                className="rounded w-full h-full object-cover"
                ...
                <li className="relative bg-white flex flex-col justify-between border rounded shadow-md hover:shadow-primary-400">
                    ...
                    <div className="flex flex-col justify-beetween gap-3 px-4 py-2">
                        <p className="text-gray-600 two-lines line-clamp-4">
                            Typewise is an AI Communication Assistant that helps customer service
                            and sales teams communicate faster and more effectively.
                        </p>
                        <ul className="flex flex-wrap items-center justify-start text-sm gap-2">
                            <li
                                title="Pricing type"
