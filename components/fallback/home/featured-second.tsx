export default function FeaturedSecond({data}: any) {
    return (
        <div className="bg-gray-700 1p-4 min-h-screen">
            <div
                aria-hidden="true"
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
                ...
                <div className="mt-16 grid grid-cols-2 divide-x divide-y  divide-gray-700 overflow-hidden  rounded-3xl border text-gray-600 border-gray-700 sm:grid-cols-2 lg:grid-cols-4  lg:divide-y-0 xl:grid-cols-4">
